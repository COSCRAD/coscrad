...
export const MultilingualTextPresenter = ({
    ...
    const { defaultUILanguageCode: defaultLanguageCode, defaultIndigenousLanguageCode } =
        useContext(ConfigurableContentContext);

    const defaultLanguageCodeForPresenter =
        resourceType === ResourceType.term ? defaultIndigenousLanguageCode : defaultLanguageCode;
