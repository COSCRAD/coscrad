# NEEDS UPDATE FOR admin-web-client

# @coscrad/admin-web-client
...
and its validation become unwieldy. At this point, `admin-web-client` will become
...
> > npx nx test admin-web-client

To run a single test by name, run

> > npx nx test admin-web-client --test-file=<mytest.spec.tsx>

To run a single test by RegExp, run

> > npx nx test admin-web-client --test-path-pattern=<PATTERN_TO_MATCH>
...
> > npx nx test admin-web-client -- --test-file=<name-of-test-file> -u
