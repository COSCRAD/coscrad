...
import {
    ArangoCommandRepositoryForAggregate,
    IEventRepository,
} from './arango-command-repository-for-aggregate';
...
export class ArangoSongCommandRepository
    extends ArangoCommandRepositoryForAggregate<Song>
    implements IRepositoryForAggregate<Song>
{
    protected readonly aggregateType = AggregateType.song;

    constructor(
        @Inject(ArangoEventRepository) protected readonly eventRepository: IEventRepository,
        protected readonly snapshotRepositoryForAggregate: IRepositoryForAggregate<Song>
    ) {
        super(eventRepository, snapshotRepositoryForAggregate);
    }
