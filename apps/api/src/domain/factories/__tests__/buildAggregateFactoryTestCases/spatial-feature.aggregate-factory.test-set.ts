...
import { PointCoordinates } from '../../../models/spatial-feature/point/entities/point-coordinates.entity';
            ...
            dto: validPoint
                .clone<Point>({
                    geometry: {
                        ...
                        coordinates: PointCoordinates.fromTuple([12, 'foo' as unknown as number]),
                    },
                })
                .toDTO(),
