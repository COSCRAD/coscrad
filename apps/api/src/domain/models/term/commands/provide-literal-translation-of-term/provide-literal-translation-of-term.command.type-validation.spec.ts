...
const commandFsaFactory = new DummyCommandFsaFactory<ProvideLiteralTranslationOfTerm>((id) =>
...
describe(`${commandType} (payload type validation)`, () => {
    describe(`when the command payload type is invalid`, () => {
        ...
        describe(`fuzz test`, () => {
            generateCommandFuzzTestCases(ProvideLiteralTranslationOfTerm).forEach(
