...
const commandFsaFactory = new DummyCommandFsaFactory<AddVideoForTerm>((id) =>
...
describe(`${commandType} (payload type validation)`, () => {
    describe(`when the command payload type is invalid`, () => {
        describe(`when the aggregate type is not video`, () => {
            Object.values(AggregateType)
                ...
                .forEach((invalidAggregateType) => {
                    ...
                    const commandInstance = plainToInstance(AddVideoForTerm, invalidFsa.payload);
        ...
        describe(`fuzz test`, () => {
            generateCommandFuzzTestCases(AddVideoForTerm).forEach(
