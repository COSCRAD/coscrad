...
const dummyFsa = buildTestCommandFsaMap().get(commandType) as CommandFSA<TranslateNote>;

const languageCode = LanguageCode.English;

const translation = 'this is the translation';

const commandFsaFactory = new DummyCommandFsaFactory<TranslateNote>(() =>
...
describe(`${commandType} (payload type validation)`, () => {
    describe(`when the command payload type is invalid`, () => {
        describe(`when the aggregate type is not edge connection`, () => {
            Object.values(AggregateType)
                ...
                .forEach((invalidAggregateType) => {
                    ...
                    const commandInstance = plainToInstance(TranslateNote, invalidFsa.payload);
        ...
        describe(`fuzz test`, () => {
            generateCommandFuzzTestCases(TranslateNote).forEach(
