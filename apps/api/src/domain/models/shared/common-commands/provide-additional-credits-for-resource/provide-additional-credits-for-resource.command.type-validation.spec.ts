...
const dummyFsa = buildTestCommandFsaMap().get(
    commandType
) as CommandFSA<ProvideAdditionalCreditsForResource>;

const commandFsaFactory = new DummyCommandFsaFactory<ProvideAdditionalCreditsForResource>(() =>
...
describe(`${commandType} (payload type validation)`, () => {
    describe(`when the command payload type is invalid`, () => {
        ...
        describe(`fuzz test`, () => {
            generateCommandFuzzTestCases(ProvideAdditionalCreditsForResource).forEach(
