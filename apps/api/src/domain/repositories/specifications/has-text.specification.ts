...
export class HasText implements ISpecification<ArangoDocumentForAggregateRoot<Term>, string> {
    ...
    isSatisfiedBy(model: ArangoDocumentForAggregateRoot<Term>): boolean {
