...
import {
    ...
    GeometricFeatureTypeToSpatialFeatureModel,
...
>(
...
): GeometricFeatureTypeToSpatialFeatureModel[TGeometricFeatureType] => {
    ...
    const searchResult = new DeluxeInMemoryStore(buildTestDataInFlatFormat())
        ...
        .find(
            ...
            ): spatialFeature is GeometricFeatureTypeToSpatialFeatureModel[TGeometricFeatureType] =>
