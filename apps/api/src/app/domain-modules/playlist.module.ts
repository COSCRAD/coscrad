...
import { AudioItemsImportedToPlaylistEventHandler } from '../../domain/models/playlist/commands/import-audio-items-to-playlist/audio-items-imported-to-playlist.event-handler';
...
@Module({
    ...
    providers: [
        ...
        AudioItemAddedToPlaylistEventHandler,
        AudioItemsImportedToPlaylistEventHandler,
        // Data Classes
        ...[
            Playlist,
            CreatePlayList,
